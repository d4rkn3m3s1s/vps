...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/public/v1/whatsapp/media/:deviceId/:file', title: 'Yakalanan medyayı indir', desc: 'WHATSAPP_MEDIA_CAPTURED webhook’undaki mediaUrl bu ucu gösterir. fetch-media’den farkı: iş oluşturmaz, sunucuda saklanan dosyayı anında ham olarak döner.' },
